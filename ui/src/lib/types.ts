...
// Task breakdown per feature (generated by story planner agent)
...
export interface Feature {
  ...
  tasks?: FeatureTask[]             // Story planner task breakdown
  review_status?: string | null     // Review pipeline status
  ac_labels?: string[]              // AC quality labels: auto-testable | needs-fixture | human-only
  escalation_reason?: string | null // Set by testing agent when AC cannot be verified
}
