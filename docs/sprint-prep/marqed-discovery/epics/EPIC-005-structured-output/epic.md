...
- [ ] Output schema validates against all entity types
- [ ] Claude API returns structured JSON matching the schema
- [ ] Generated entities parse correctly into typed models
