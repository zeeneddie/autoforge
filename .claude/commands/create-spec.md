...
**Output location:** `$ARGUMENTS/.mq-devengine/prompts/app_spec.txt` and `$ARGUMENTS/.mq-devengine/prompts/initializer_prompt.md`
...
The output directory is: `$ARGUMENTS/.mq-devengine/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `$ARGUMENTS/.mq-devengine/prompts/app_spec.txt`
...
**Output path:** `$ARGUMENTS/.mq-devengine/prompts/initializer_prompt.md`
...
**Output path:** `$ARGUMENTS/.mq-devengine/prompts/.spec_status.json`
...
```json
{
  ...
  "files_written": [
    ".mq-devengine/prompts/app_spec.txt",
    ".mq-devengine/prompts/initializer_prompt.md"
  ],
...
```json
{
  ...
  "files_written": [
    ".mq-devengine/prompts/app_spec.txt",
    ".mq-devengine/prompts/initializer_prompt.md",
    ".mq-devengine/prompts/coding_prompt.md"
  ],
  "feature_count": 35
}
```
...
> "Your specification files have been created in `$ARGUMENTS/.mq-devengine/prompts/`!
>
> **Files created:**
> - `$ARGUMENTS/.mq-devengine/prompts/app_spec.txt`
> - `$ARGUMENTS/.mq-devengine/prompts/initializer_prompt.md`
>
